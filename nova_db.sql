...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 13 2022 г., 01:15
...
INSERT INTO `apartments` (`id`, `photo`, `status`, `name`, `description`, `price`, `address`, `user_name`, `user_phone`, `views`) VALUES
(1, 'work-8.jpg', 'Продажа', '1-я квартира, 37м²', 'Очень удобное, красивое место в историческом центре города. В двух шагах прогулочная набережная. На набережной выделены велодорожки и дорожки для бега. До площади и парка Зарядье пешком минут 15-20. ', 3080000, 'Пенза, ул. Аустрина, 1', 'Сергей', '+7 (954) 321-04-32', 0),
(2, 'work-2.jpg', 'Продажа', '1-я квартира, 67м²', 'ЖК \"Spires\"  городские резиденции премиум-класса. Этот жилой комплекс располагается поблизости от \"Долины реки Сетунь\", самого большого природного заказника. Здесь великолепная экология, чистота и спокойствие. Расслабьтесь после напряженного рабочего дня, полюбуйтесь природой, насладитесь живописными пейзажами, ароматами цветов и пением птиц.', 8670000, 'Пенза, ул. Пушкина, 140', 'Диана', '+7 (927) 381-24-12', 0),
(3, 'work-1.jpg', 'Продажа', 'Вилла, 189м²', 'Продаётся квартира с дизайнерской отделкой в одном из лучших спальных районов. В квартире выполнен качественный ремонт с заменой сантехники, электрики, радиаторов отопления. Выровнены стены и полы, заменены окна.</br></br>Коридор: полы керамогранит Испания с подогревом, стены краска, гардеробная, входная дверь мдф с зеркалом.</br></br>Ванна: стены керамогранит Испания, пол керамогранит Испания с подогревом, стиральная машина Hotpoint, зеркало с подсветкой, полотенцесушитель, ванна, ревизионный люк для доступа к коммуникациям.', 23800000, 'Засечное, ул. Радужная, 234', 'Андрей', '+7 (904) 827-23-39', 2),
(4, 'work-7.jpg', 'Продажа', 'Загородный дом, 102м²', 'Дом принадлежит к исторической застройке района. Это доходный дом Баскакова. Ранее в нем проживали актеры театра и финансовая элита. В доме обновлены коммуникации, установлены новые лифты. Фасад дома представляет собой произведение современного искусства. В доме оборудована входная группа со световой инсталляцией и скульптурной композицией.', 4670000, 'Засечное, ул. 1-е Октября, 14', 'Светлана', '+7 (904) 173-32-32', 6),
(5, 'work-5.jpg', 'Аренда', 'Загородный дом, 110м²', 'В аренду предлагается дизайнерский, уютный загородный дом. Дизайнерский ремонт с отделкой в стиле неоклассика, панорамный вид. Апартамент полностью оборудован мебелью и техникой.', 34000, 'Засечное, ул. 1-е Октября, 54', 'Олег', '+7 (922) 299-98-99', 938),
(6, 'work-9.jpg', 'Продажа', 'Пентхаус , 77м²', 'Апартаменты свежие, полностью адаптированы для проживания (вы будете как дома, а не как в гостинице). В отличии от аналогов, в представленных апартаментах, действительно, дизайнерский ремонт из приятных материалов (на полу паркетная доска, а не ламинат, качественная плитка, на стенах дизайнерская штукатурка) встроенные вместительные шкафы (до потолка и большого размера, а не отдельно стоящий небольшой шкаф, все ваши вещи поместятся), функциональная техника со всем необходимым набором возможностей (стиралка с сушкой, кондиционер, посудомоечная машина и так далее (нет на фото телевизора, мы его доставим, если будет такая необходимость).', 4880000, 'Пенза, ул. 8 Марта, 140', 'Сергей', '+7 (954) 367-12-00', 10);
