...
--
-- Хост: 192.168.2.12:3306
-- Время создания: Апр 25 2022 г., 10:26
...
CREATE TABLE `news` (
  `id` int(11) NOT NULL,
  `rubrika` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
